		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... params) {
				try {
					...
					obj10.setPosition(new float[] { -2f, 2f, 0.5f });
					addObject(obj10);
					...
					obj11.setPosition(new float[] { -2f, 2f, 0f });
...
//					obj12.setPosition(new float[] { 0f, 2f, -1f });
//					addObject(obj12);

					// test loading object
//					try {
//						// this has no color array
//						Object3DData android = Object3DBuilder.loadV5(parent.getAssets(), "models", "gupen.stl");
...
//					try {
//						// this has no color array
//						Object3DData obj51 = Object3DBuilder.loadV5(parent.getAssets(), "models", "bei.stl");
...
//						Object3DData obj52 = Object3DBuilder.loadV5(parent.getAssets(), "models", "bukuai1.stl");
...
//						Object3DData obj53 = Object3DBuilder.loadV5(parent.getAssets(), "models", "bukuai2.stl");
